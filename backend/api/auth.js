...
router.post('/login', async (req, res) => {
  ...
  try {
    ...
    if (user.status === 'temporary') {
      console.log(
        `[DEBUG LOGIN] Usuario ${correo} es temporal. Generando token para completar registro.`
      );
      ...
      return res.json({
        tempToken,
        message:
          'Por favor, completa tu registro estableciendo una nueva contraseña.',
      });
    }
    ...
    // Construir y loguear el payload de respuesta
