...
import useAppStore, { availablePaymentMethods } from '@/stores/store';const PaymentEditor = () => {
  ...
  const [newInstallment, setNewInstallment] = useState({ type: 'monthly', max: 3 });  const handleCheckboxChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    <div className="mt-8 p-4 border rounded-md bg-gray-50">
      <h2 className="text-xl font-semibold text-gray-700 mb-4">Métodos y Condiciones de Pago</h2>      {/* Métodos de Pago */}
      <div className="mb-6">
      ...
      <div className="space-y-4">
        ...
        </label>        <div className="p-4 border rounded-lg bg-white">
          <label className="flex items-center gap-4 cursor-pointer">
        ...
        </div>        <div className="p-4 border rounded-lg bg-white">
          <label className="flex items-center gap-4 cursor-pointer">
